package Formation_CAIT.Selenium_Webdriver;
	...
	protected static WebDriver driver;
		...
		@Test
		public static void testTCADDLOCATION() throws InterruptedException {
		    ...
		    Thread.sleep(1000);
		    driver.findElement(By.id("location_name")).sendKeys("LFP");
		    Thread.sleep(1000);
		    new Select(driver.findElement(By.id("location_country"))).selectByVisibleText("Tunisie");
		    Thread.sleep(2000);
