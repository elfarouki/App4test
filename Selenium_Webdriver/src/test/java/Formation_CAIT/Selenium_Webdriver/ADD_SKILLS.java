...
protected static WebDriver driver;
	...
	@Test
	public static void AjouterCompetence() throws InterruptedException {
	    ...
	    Thread.sleep(1000);
	    driver.findElement(By.id("skill_name")).sendKeys("JAVA");
	    Thread.sleep(1000);
	    driver.findElement(By.id("skill_description")).sendKeys("3 ans d'expérience");
	    Thread.sleep(1000);
