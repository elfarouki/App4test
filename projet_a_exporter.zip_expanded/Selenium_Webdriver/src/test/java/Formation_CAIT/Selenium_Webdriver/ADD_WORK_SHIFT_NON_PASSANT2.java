	...
	public class ADD_WORK_SHIFT_NON_PASSANT2 {
	...
	protected static WebDriver driver;
		...
		public static void ConnectAccount() throws InterruptedException {
		    ...
		    driver.findElement(By.id("workShift_name")).sendKeys("Testeur1");
		    new Select(driver.findElement(By.id("workShift_workHours_from"))).selectByVisibleText("12:15");
		    new Select(driver.findElement(By.id("workShift_workHours_to"))).selectByVisibleText("08:15");
//		    assert false (selenium.isTestPresent("Date incorrecte."));
